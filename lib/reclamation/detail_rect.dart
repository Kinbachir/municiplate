...
class DetatilRect extends StatelessWidget {
  const DetatilRect({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<SharedPreferences>(
      ...
      builder:
        ...
        String news = snapshot.data!.getString("recl").toString();
...
class _BookingScreenState extends State<BookingScreen> {
  ...
  Reclamation? newsModel;
  @override
  void initState() {
    newsModel = Reclamation.fromJson(jsonDecode(index!));
    super.initState();
  }
